        ...
        >
          <ReactMarkdown
            components={{
              ...
              h1: ({ children }) => (
                <h1 className="font-serif text-4xl font-light text-foreground mb-8 mt-12">
                  {children}
                </h1>
              ),
              h2: ({ children }) => (
                <h2 className="font-serif text-3xl font-light text-foreground mb-6 mt-10">
                  {children}
                </h2>
              ),
              h3: ({ children }) => (
                <h3 className="font-serif text-2xl font-light text-foreground mb-4 mt-8">
                  {children}
                </h3>
              ),
              blockquote: ({ children }) => (
              ...
              em: ({ children }) => (
                <em className="text-primary font-serif not-italic">
                  {children}
                </em>
              ),
              ...
              ol: ({ children }) => (
                <ol className="space-y-3 my-6 text-foreground/80 list-decimal list-inside">
                  {children}
                </ol>
              ),
              li: ({ children }) => (
